...
//User define
	...
	logic[16:0] h2c_len_in_byte_buf;
	logic[7:0] h2c_max_hburst_len_buf;
	...
	logic[16:0] c2h_len_in_byte_buf;
	logic[7:0] c2h_max_hburst_len_buf;
	logic[8:0] c2h_max_hburst_len;
	logic[11:0] BL2;
	logic[5:0] Split_on_BL_modulo;
	
	logic[63:0] dst_addr_buf;
	logic[31:0] c2h_lenInByte_buf_32bits;
	logic[51:0] after_shift_dst_addr;
	logic[4:0] num_split_on_4K_Boundary;
	

//-------------------------------------WSTRB
	logic[63:0] input_wstrb;
	logic value = 0;
	int host_num_0 = 0;
	int host_num_1 = 0;
	int card_num_0 = 0;
	int card_num_1 = 0;
	logic host_wlast;
	logic host_wlast_pre;
	logic card_wlast;
	logic card_wlast_pre;
...
//`endif
  ...
  DmaMM_asymmetric_cdw32 A_DUT(
    ...
    .m_card_axi_WDATA           (IF_vwrap.m_card_axi.wdata[pdma_dut_pkg::CARD_DATA_WIDTH - 1:0]),
    ...
    .m_card_axi_RDATA           (IF_vwrap.m_card_axi.rdata[pdma_dut_pkg::CARD_DATA_WIDTH - 1:0]),
    ...
    .m_host_axi_RDATA   (IF_vwrap.m_host_axi.rdata[pdma_dut_pkg::HOST_DATA_WIDTH - 1:0]),
    ...
    .m_host_axi_WDATA   (IF_vwrap.m_host_axi.wdata[pdma_dut_pkg::HOST_DATA_WIDTH - 1:0]),
