...
//--------------------------------------
  ...
  DmaST_asymmetric_hdw128_cdw16 A_DUT(
...
//  assign IF_vwrap.s_c2h_dma.data_value[MAX_DATA_WIDTH - 1:CARD_DATA_WIDTH] = 0;
//  assign IF_vwrap.s_h2c_dma.data_value[MAX_DATA_WIDTH - 1:CARD_DATA_WIDTH] = 0;
...
//  assign h2c_lenInByte_low_6bits = IF_vwrap.s_h2c_dma.desc_len[5:0];
//  assign src_addr_low_6bits = IF_vwrap.s_h2c_dma.desc_addr[5:0];
//	
//  assign h2c_len_in_byte_buf = IF_vwrap.s_h2c_dma.desc_len;
//  assign h2c_max_hburst_len_buf = IF_vwrap.s_h2c_dma.desc_axi_max_len;
...
//  
//  assign c2h_lenInByte_low_6bits = IF_vwrap.s_c2h_dma.desc_len[5:0];
//  assign c2h_lenInByte_low_12bits = IF_vwrap.s_c2h_dma.desc_len[11:0];
//	
//  assign dst_addr_low_6bits = IF_vwrap.s_c2h_dma.desc_addr[5:0];
//  assign dst_addr_low_12bits = IF_vwrap.s_c2h_dma.desc_addr[11:0];
//  assign dst_addr_aligned = dst_addr_low_12bits & 12'b111111000000;
//	
//  assign c2h_len_in_byte_buf = IF_vwrap.s_c2h_dma.desc_len;
//  assign c2h_max_hburst_len_buf = IF_vwrap.s_c2h_dma.desc_axi_max_len;
...
//	
//	
//  assign dst_addr_buf = IF_vwrap.s_c2h_dma.desc_addr;
//  assign c2h_lenInByte_buf_32bits = IF_vwrap.s_c2h_dma.desc_len;
//  assign after_shift_dst_addr = dst_addr_buf >> 12;
//
//  assign c2h_mty = IF_vwrap.s_c2h_dma.data_side_info[21:16];
//  assign h2c_mty = IF_vwrap.s_h2c_dma.data_side_info[21:16];
//	
//  assign c2h_tlast = IF_vwrap.s_c2h_dma.data_last;
//  assign h2c_tlast = IF_vwrap.s_h2c_dma.data_last;
//	
//  assign c2h_TREADY = IF_vwrap.s_c2h_dma.data_ready;
//  assign c2h_TVALID = IF_vwrap.s_c2h_dma.data_valid;
//	
//  assign h2c_TREADY = IF_vwrap.s_h2c_dma.data_ready;
//  assign h2c_TVALID = IF_vwrap.s_h2c_dma.data_valid;

	
	
//---------------------------------WSTRB
//  assign input_wstrb = IF_vwrap.m_host_axi.wstrb;
//  assign wlast = IF_vwrap.m_host_axi.wlast;
//	
//  assign WVALID = IF_vwrap.m_host_axi.wvalid;
//  assign WREADY = IF_vwrap.m_host_axi.wready;
