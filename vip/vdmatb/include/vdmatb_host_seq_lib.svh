`ifndef __VDMATB_HOST_SEQ_LIB_SVH__
`define __VDMATB_HOST_SEQ_LIB_SVH__





class vdmatb_host_default_seq extends vdmatb_host_seq;

  `uvm_object_utils(vdmatb_host_default_seq)
  function new(string name="vdmatb_host_default_seq");
    super.new(name);
  endfunction

endclass:vdmatb_host_default_seq




class vdmatb_host_asymmetric_latency_seq extends vdmatb_host_seq;

  `uvm_object_utils(vdmatb_host_asymmetric_latency_seq)
  function new(string name="vdmatb_host_asymmetric_latency_seq");
    super.new(name);
  endfunction
...
endclass:vdmatb_host_asymmetric_latency_seq




class vdmatb_host_data_boundary_seq extends vdmatb_host_seq;

  `uvm_object_utils(vdmatb_host_data_boundary_seq)
  function new(string name="vdmatb_host_data_boundary_seq");
    super.new(name);
  endfunction
...
endclass:vdmatb_host_data_boundary_seq



class vdmatb_host_fault_host_b_wrong_resp_seq extends vdmatb_host_seq;

	`uvm_object_utils(vdmatb_host_fault_host_b_wrong_resp_seq)
	function new(string name="vdmatb_host_fault_host_b_wrong_resp_seq");
		super.new(name);
	endfunction
...
endclass:vdmatb_host_fault_host_b_wrong_resp_seq




class vdmatb_host_fault_host_r_wrong_resp_seq extends vdmatb_host_seq;

	`uvm_object_utils(vdmatb_host_fault_host_r_wrong_resp_seq)
	function new(string name="vdmatb_host_fault_host_r_wrong_resp_seq");
		super.new(name);
	endfunction
...
endclass:vdmatb_host_fault_host_r_wrong_resp_seq
...
class vdmatb_host_perf_seq extends vdmatb_host_seq;
  
  `uvm_object_utils(vdmatb_host_perf_seq)
  function new(string name="vdmatb_host_perf_seq");
    super.new(name);
  endfunction
        ...
        `uvm_rand_send_with(this.req,
          {
            ...
            foreach(rvalid_delay[i]) {
              if (i == 0) rvalid_delay[i] == scfg.perf_ctrl_knob.perf_host_side_latency;
              else rvalid_delay[i] inside {[rvalid_min:(rvalid_max)]};
            }
            addr_ready_delay inside {[addr_read_ready_delay_min:addr_read_ready_delay_max]};
          })
        ...
        `uvm_rand_send_with(this.req,
          {
            ...
            if (enable_aw_to_b_delay) 
              bvalid_delay inside {bvalid_max};
            else  bvalid_delay == scfg.perf_ctrl_knob.perf_host_side_latency;
            bresp inside{ AxiSlvTrans_t::OKAY };
            addr_ready_delay inside {[addr_write_ready_delay_min:addr_write_ready_delay_max]};
          })
      end
...
class vdmatb_host_all_random_seq extends vdmatb_host_seq;

  `uvm_object_utils(vdmatb_host_all_random_seq)
  function new(string name="vdmatb_host_all_random_seq");
    super.new(name);
  endfunction
...
endclass:vdmatb_host_all_random_seq



class vdmatb_host_constrained_random_seq extends vdmatb_host_seq;
  
  `uvm_object_utils(vdmatb_host_constrained_random_seq)
  function new(string name="vdmatb_host_constrained_random_seq");
    super.new(name);
  endfunction
...
endclass:vdmatb_host_constrained_random_seq



class vdmatb_host_rdy_signal_state_for_func_cov_seq extends vdmatb_host_seq;

  `uvm_object_utils(vdmatb_host_rdy_signal_state_for_func_cov_seq)
  function new(string name="vdmatb_host_rdy_signal_state_for_func_cov_seq");
    super.new(name);
  endfunction
  ...
  virtual protected task doSend();
    ...
    forever begin
      ...
      this.p_sequencer.response_request_port.peek(found);
      found.port_cfg.toggle_ready_signals_during_idle_period = 1;
      found.random_interleave_array = new[found.burst_length];
      $cast(this.req, found);
...
endclass:vdmatb_host_rdy_signal_state_for_func_cov_seq




class vdmatb_host_full_start_w_fifo_seq extends vdmatb_host_seq;

  `uvm_object_utils(vdmatb_host_full_start_w_fifo_seq)
  function new(string name="vdmatb_host_full_start_w_fifo_seq");
    super.new(name);
  endfunction
  ...
  virtual protected task doSend();
    ...
    forever begin
      ...
      this.p_sequencer.response_request_port.peek(found);
      found.port_cfg.num_outstanding_xact           = 128;
      found.port_cfg.cov_bins_num_outstanding_xacts = 64;
      found.random_interleave_array = new[found.burst_length];
      $cast(this.req, found);
...
endclass:vdmatb_host_full_start_w_fifo_seq


class vdmatb_host_fault_cover_all_dma_id_bits_from_host_fault_seq extends vdmatb_host_seq;

	`uvm_object_utils(vdmatb_host_fault_cover_all_dma_id_bits_from_host_fault_seq)
	function new(string name="vdmatb_host_fault_cover_all_dma_id_bits_from_host_fault_seq");
		super.new(name);
	endfunction
        ...
        `uvm_rand_send_with(this.req,
          {
            ...
            foreach(rvalid_delay[i]) {
              if (i == 0) rvalid_delay[i] inside {[1:1]};
              else rvalid_delay[i] inside {[1:1]};
            }
...
endclass:vdmatb_host_fault_cover_all_dma_id_bits_from_host_fault_seq



`endif // __VDMATB_HOST_SEQ_LIB_SVH__
