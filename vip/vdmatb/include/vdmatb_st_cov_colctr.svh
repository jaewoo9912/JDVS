`ifndef __VDMATB_ST_COV_COLCTR_SVH__
`define __VDMATB_ST_COV_COLCTR_SVH__

class vdmatb_st_cov_colctr extends vmg_obj;
  ...
  covergroup cg_perf_scenario;
    ...
    dst_addr : coverpoint (DutParamHostAddr_t'(this.perf_ctrl_knob.perf_dst_addr[5:0])) {
      bins perf_c2h_dst_addr[] = {[0:63]};
    }
    
    src_addr : coverpoint (DutParamHostAddr_t'(this.perf_ctrl_knob.perf_src_addr[5:0])) {
      bins perf_h2c_src_addr[] = {[0:63]};
    }
    ...
    host_side_latency : coverpoint (this.perf_ctrl_knob.perf_host_side_latency) {
      ...
      bins max_perf_host_side_latency[] = {400};
    }
  ...
  `uvm_object_utils(vdmatb_st_cov_colctr) 
  function new (string name = "vdmatb_st_cov_colctr");
    super.new(name);
...
function void vdmatb_st_cov_colctr::set_C2HActualResult(PdmaC2HPerfResult_t me);
  this.c2h_specific_result = me;
endfunction


function void vdmatb_st_cov_colctr::set_H2CActualResult(PdmaH2CPerfResult_t me);
  this.h2c_specific_result = me;
endfunction



function void vdmatb_st_cov_colctr::sampleActualPerfResult();
  cg_perf_result.sample();
endfunction


function void vdmatb_st_cov_colctr::set_PerfExpected_CP(vdmatb_scfg scfg);
...
function void vdmatb_st_cov_colctr::set_PerfScenario_CP(vdmatb_scfg scfg);
...
function void vdmatb_st_cov_colctr::samplePerfScenario(vdmatb_scfg scfg);
...
`endif //__VDMATB_ST_COV_COLCTR_SVH__
