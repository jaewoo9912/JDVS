`ifndef __VDMA_ST_C2H_MST_PERF_SEQ_SVH__
`define __VDMA_ST_C2H_MST_PERF_SEQ_SVH__



class vdma_st_c2h_mst_perf_seq extends vdma_st_c2h_mst_seq;

  int   cnt_addr = 0;
  Len_t len;
  
  `uvm_object_utils(vdma_st_c2h_mst_perf_seq)

  function new (string name="vdma_st_c2h_mst_perf_seq");
     super.new(name);
...
endclass:vdma_st_c2h_mst_perf_seq


function void vdma_st_c2h_mst_perf_seq::genCfg();
...
task vdma_st_c2h_mst_perf_seq::pre_genCfg();
...
function vdma_st_c2h_mst_perf_seq::FncId_t vdma_st_c2h_mst_perf_seq::decideCstrMaxBL();
...
function vdma_st_c2h_mst_perf_seq::SeqItem_t vdma_st_c2h_mst_perf_seq::post_createSeqItem(SeqItem_t me);
...
function vdma_st_c2h_mst_perf_seq::Addr_t vdma_st_c2h_mst_perf_seq::decideCstrAddr();
  Addr_t rnd_addr;
...
function vdma_st_c2h_mst_perf_seq::Len_t vdma_st_c2h_mst_perf_seq::decideCstrLen();
  if(this.tcfg.perf_ctrl_knob.perf_crossing == NO) begin
...
`endif // __VDMA_ST_C2H_MST_PERF_SEQ_SVH__
