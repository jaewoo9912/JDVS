`ifndef __VDMA_ST_FAULT_CARD_R_WRONG_MTY_SEQ_SVH__
`define __VDMA_ST_FAULT_CARD_R_WRONG_MTY_SEQ_SVH__



class vdma_st_fault_card_r_wrong_mty_seq extends vdma_st_c2h_mst_seq;


	`uvm_object_utils(vdma_st_fault_card_r_wrong_mty_seq)

	function new (string name="vdma_st_fault_card_r_wrong_mty_seq");
		super.new(name);
	endfunction
...
endclass:vdma_st_fault_card_r_wrong_mty_seq

function vdma_st_fault_card_r_wrong_mty_seq::T_SEQ_ITEM vdma_st_fault_card_r_wrong_mty_seq::createC2HFaultSeqItemQ(vdma_seq_item me);
...
function vdma_st_fault_card_r_wrong_mty_seq::T_SEQ_ITEM_Q vdma_st_fault_card_r_wrong_mty_seq::createSeqItemQ(string name_postfix="");
...
function void vdma_st_fault_card_r_wrong_mty_seq::genCfg();
...
task vdma_st_fault_card_r_wrong_mty_seq::pre_genCfg();
...
`endif // __VDMA_ST_FAULT_CARD_R_WRONG_MTY_SEQ_SVH__
