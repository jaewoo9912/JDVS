`ifndef __VDMA_ST_C2H_SMALL_LEN_IN_BYTE_SEQ_SVH__
`define __VDMA_ST_C2H_SMALL_LEN_IN_BYTE_SEQ_SVH__



class vdma_st_c2h_small_len_in_byte_seq extends vdma_st_c2h_mst_seq;

  `uvm_object_utils(vdma_st_c2h_small_len_in_byte_seq)

  function new (string name="vdma_st_c2h_small_len_in_byte_seq");
	  super.new(name);
  endfunction
...
endclass:vdma_st_c2h_small_len_in_byte_seq

function void vdma_st_c2h_small_len_in_byte_seq::genCfg();
...
task vdma_st_c2h_small_len_in_byte_seq::pre_genCfg();
...
`endif // __VDMA_ST_C2H_SMALL_LEN_IN_BYTE_SEQ_SVH__
