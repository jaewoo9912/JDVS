`ifndef __VDMA_ST_FAULT_C2H_ALL_RANDOM_SEQ_SVH__
`define __VDMA_ST_FAULT_C2H_ALL_RANDOM_SEQ_SVH__



class vdma_st_fault_c2h_all_random_seq extends vdma_st_c2h_mst_seq;


	`uvm_object_utils(vdma_st_fault_c2h_all_random_seq)

	function new (string name="vdma_st_fault_c2h_all_random_seq");
		super.new(name);
...
endclass:vdma_st_fault_c2h_all_random_seq

function vdma_st_fault_c2h_all_random_seq::T_SEQ_ITEM vdma_st_fault_c2h_all_random_seq::createDataLenZero_SeqItemQ(T_SEQ_ITEM me);
...
function vdma_st_fault_c2h_all_random_seq::SeqItem_t vdma_st_fault_c2h_all_random_seq::createDataLenZero_SeqItem(string name_postfix="");
  vdma_seq_item created;
...
function vdma_st_fault_c2h_all_random_seq::T_SEQ_ITEM vdma_st_fault_c2h_all_random_seq::createPrematureLast_SeqItemQ(T_SEQ_ITEM me);
  vdma_seq_item created;
  int selected;
...
function vdma_st_fault_c2h_all_random_seq::T_SEQ_ITEM vdma_st_fault_c2h_all_random_seq::createNoLast_SeqItemQ(T_SEQ_ITEM me);
  vdma_seq_item created;
...
function vdma_st_fault_c2h_all_random_seq::T_SEQ_ITEM vdma_st_fault_c2h_all_random_seq::createWrongMty_SeqItemQ(T_SEQ_ITEM me);
  vdma_seq_item created;
...
function vdma_st_fault_c2h_all_random_seq::T_SEQ_ITEM vdma_st_fault_c2h_all_random_seq::createWrongDmaId_SeqItemQ(T_SEQ_ITEM me);
  vdma_seq_item created;
...
function vdma_st_fault_c2h_all_random_seq::T_SEQ_ITEM vdma_st_fault_c2h_all_random_seq::selectFaultCase(RatioFaultInjection_t fault_ratio);
  T_SEQ_ITEM created;
...
function vdma_st_fault_c2h_all_random_seq::T_SEQ_ITEM_Q vdma_st_fault_c2h_all_random_seq::createSeqItemQ(string name_postfix="");
  ...
  if( this.getTransType() == ST_C2H ) begin
    if(FlipCoin(this.tcfg.fault_ratio)) begin
...
function void vdma_st_fault_c2h_all_random_seq::genCfg();
...
task vdma_st_fault_c2h_all_random_seq::pre_genCfg();
...
`endif // __VDMA_ST_FAULT_C2H_ALL_RANDOM_SEQ_SVH__
