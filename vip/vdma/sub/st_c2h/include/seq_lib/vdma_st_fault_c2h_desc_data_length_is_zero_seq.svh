`ifndef __VDMA_ST_FAULT_C2H_DESC_DATA_LENGTH_IS_ZERO_SEQ_SVH__
`define __VDMA_ST_FAULT_C2H_DESC_DATA_LENGTH_IS_ZERO_SEQ_SVH__



class vdma_st_fault_c2h_desc_data_length_is_zero_seq extends vdma_st_c2h_mst_seq;
	

	`uvm_object_utils(vdma_st_fault_c2h_desc_data_length_is_zero_seq)

	function new (string name="vdma_st_fault_c2h_desc_data_length_is_zero_seq");
		super.new(name);
	endfunction
...
endclass:vdma_st_fault_c2h_desc_data_length_is_zero_seq

function vdma_st_fault_c2h_desc_data_length_is_zero_seq::T_SEQ_ITEM vdma_st_fault_c2h_desc_data_length_is_zero_seq::createC2HFaultSeqItem(vdma_seq_item me);
...
function vdma_st_fault_c2h_desc_data_length_is_zero_seq::SeqItem_t vdma_st_fault_c2h_desc_data_length_is_zero_seq::createSeqItem_DataLenZero(string name_postfix="");
	vdma_seq_item created;
...
function vdma_st_fault_c2h_desc_data_length_is_zero_seq::T_SEQ_ITEM_Q vdma_st_fault_c2h_desc_data_length_is_zero_seq::createSeqItemQ(string name_postfix="");
  T_SEQ_ITEM    created;
...
function void vdma_st_fault_c2h_desc_data_length_is_zero_seq::genCfg();
...
task vdma_st_fault_c2h_desc_data_length_is_zero_seq::pre_genCfg();
...
`endif // __VDMA_ST_FAULT_C2H_DESC_DATA_LENGTH_IS_ZERO_SEQ_SVH__
