`ifndef __VDMA_ST_C2H_MST_RANDOM_SEQ_SVH__
`define __VDMA_ST_C2H_MST_RANDOM_SEQ_SVH__
...
class vdma_st_c2h_mst_random_seq extends vdma_st_c2h_mst_seq;
  
  `uvm_object_utils(vdma_st_c2h_mst_random_seq)

  function new (string name="vdma_st_c2h_mst_random_seq");
     super.new(name);
  ...
  extern function C2HLenRange_t selectLenRange();

endclass:vdma_st_c2h_mst_random_seq

function void vdma_st_c2h_mst_random_seq::genCfg();
...
function C2HLenRange_t vdma_st_c2h_mst_random_seq::selectLenRange();
  int        select_num;
  C2HLenRange_t range;
...
function Len_t vdma_st_c2h_mst_random_seq::decideCstrLen();
  Len_t      rnd_len;
  C2HLenRange_t range;
...
task vdma_st_c2h_mst_random_seq::pre_genCfg();
...
`endif // __VDMA_ST_C2H_MST_RANDOM_SEQ_SVH__
