`ifndef __VDMA_MM_H2C_MST_PERF_SEQ_SVH__
`define __VDMA_MM_H2C_MST_PERF_SEQ_SVH__



class vdma_mm_h2c_mst_perf_seq extends vdma_mm_h2c_mst_seq;

  int   cnt_addr = 0;
  Len_t len;
   
  `uvm_object_utils(vdma_mm_h2c_mst_perf_seq)

  function new (string name="vdma_mm_h2c_mst_perf_seq");
     super.new(name);
...
endclass:vdma_mm_h2c_mst_perf_seq



function void vdma_mm_h2c_mst_perf_seq::genCfg();
...
task vdma_mm_h2c_mst_perf_seq::pre_genCfg();
...
function vdma_mm_h2c_mst_perf_seq::FncId_t vdma_mm_h2c_mst_perf_seq::decideCstrMaxBL();
...
function vdma_mm_h2c_mst_perf_seq::SeqItem_t vdma_mm_h2c_mst_perf_seq::post_createSeqItem(SeqItem_t me);
...
function Addr_t vdma_mm_h2c_mst_perf_seq::make64BAlignedAddr();
  Addr_t served_addr;
...
function vdma_mm_h2c_mst_perf_seq::Addr_t vdma_mm_h2c_mst_perf_seq::decideCstrAddr();
  Addr_t rnd_addr;
...
function vdma_mm_h2c_mst_perf_seq::Len_t vdma_mm_h2c_mst_perf_seq::decideCstrLen();
  if(this.tcfg.perf_ctrl_knob.perf_crossing == NO) begin
...
function vdma_mst_seq::SeqItem_t vdma_mm_h2c_mst_perf_seq::createSeqItem(string name_postfix="");
  ...
  created.cstr_trans_type  = MM_H2C;
  ...
  created.cstr_dst_addr    = DutParamCardAddr_t'(this.make64BAlignedAddr);
...
`endif // __VDMA_MM_H2C_MST_PERF_SEQ_SVH__
