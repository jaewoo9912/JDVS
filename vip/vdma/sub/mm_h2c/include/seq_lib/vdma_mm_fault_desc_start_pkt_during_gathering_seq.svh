`ifndef __VDMA_MM_FAULT_DESC_START_PKT_DURING_GATHERING_SEQ_SVH__
`define __VDMA_MM_FAULT_DESC_START_PKT_DURING_GATHERING_SEQ_SVH__



class vdma_mm_fault_desc_start_pkt_during_gathering_seq extends vdma_mm_h2c_mst_seq;


	`uvm_object_utils(vdma_mm_fault_desc_start_pkt_during_gathering_seq)

	function new (string name="vdma_mm_fault_desc_start_pkt_during_gathering_seq");
		super.new(name);
	endfunction
...
endclass:vdma_mm_fault_desc_start_pkt_during_gathering_seq

function vdma_mm_fault_desc_start_pkt_during_gathering_seq::T_SEQ_ITEM_Q vdma_mm_fault_desc_start_pkt_during_gathering_seq::createH2CFaultSeqItemQ(T_SEQ_ITEM created, int num_be_created, DmaId_t startPkt_dma_id);
...
function vdma_mm_fault_desc_start_pkt_during_gathering_seq::T_SEQ_ITEM_Q vdma_mm_fault_desc_start_pkt_during_gathering_seq::createSeqItemQ(string name_postfix="");
...
function void vdma_mm_fault_desc_start_pkt_during_gathering_seq::genCfg();
...
task vdma_mm_fault_desc_start_pkt_during_gathering_seq::pre_genCfg();
...
`endif // __VDMA_MM_FAULT_DESC_START_PKT_DURING_GATHERING_SEQ_SVH__
