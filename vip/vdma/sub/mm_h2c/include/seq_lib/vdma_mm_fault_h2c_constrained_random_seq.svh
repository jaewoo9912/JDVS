`ifndef __VDMA_MM_FAULT_H2C_CONSTRAINED_RANDOM_SEQ_SVH__
`define __VDMA_MM_FAULT_H2C_CONSTRAINED_RANDOM_SEQ_SVH__



class vdma_mm_fault_h2c_constrained_random_seq extends vdma_mm_h2c_mst_seq;


	`uvm_object_utils(vdma_mm_fault_h2c_constrained_random_seq)

	function new (string name="vdma_mm_fault_h2c_constrained_random_seq");
		super.new(name);
...
endclass:vdma_mm_fault_h2c_constrained_random_seq


function vdma_mm_fault_h2c_constrained_random_seq::T_SEQ_ITEM vdma_mm_fault_h2c_constrained_random_seq::createDataLenZero_SeqItemQ(T_SEQ_ITEM me);
...
function vdma_mm_fault_h2c_constrained_random_seq::T_SEQ_ITEM_Q vdma_mm_fault_h2c_constrained_random_seq::createDataLenZeroPkt_SeqItemQ(T_SEQ_ITEM created, int num_be_created, DmaId_t startPkt_dma_id);
...
function vdma_mm_fault_h2c_constrained_random_seq::SeqItem_t vdma_mm_fault_h2c_constrained_random_seq::createDataLenZero_SeqItem(string name_postfix="");
  vdma_seq_item created;
...
function vdma_mm_fault_h2c_constrained_random_seq::T_SEQ_ITEM_Q vdma_mm_fault_h2c_constrained_random_seq::createMidPkt_SeqItemQ(T_SEQ_ITEM created, int num_be_created, DmaId_t startPkt_dma_id);
  ...
  rand_num = this.pickRandUIntInTheRange2(1, num_be_created - 2);
	...
	for(int i=0; i<num_be_created; i++)begin
		created = super.createSeqItem($sformatf("pkt_gathering_seq%1d",i));
    if    (i == 0) begin created.makeIntermediateOfPacketGathering() ; startPkt_dma_id=DutParamDmaId_t'(created.getDmaId()); end
		else if (i == rand_num) created.makeStartOfPacketGathering();
...
function vdma_mm_fault_h2c_constrained_random_seq::T_SEQ_ITEM_Q vdma_mm_fault_h2c_constrained_random_seq::createSoloPkt_SeqItemQ(T_SEQ_ITEM created, int num_be_created, DmaId_t startPkt_dma_id);
  ...
  for(int i=0; i<num_be_created; i++)begin
    ...
    else if (i == rand_num) created.makeSoloPkt();
    else if (i == num_be_created-1) created.makeEndOfPacketGathering();
    else begin
      created.makeIntermediateOfPacketGathering();
    end
...
function vdma_mm_fault_h2c_constrained_random_seq::T_SEQ_ITEM_Q vdma_mm_fault_h2c_constrained_random_seq::createStartPkt_SeqItemQ(T_SEQ_ITEM created, int num_be_created, DmaId_t startPkt_dma_id);
...
function vdma_mm_fault_h2c_constrained_random_seq::T_SEQ_ITEM_Q vdma_mm_fault_h2c_constrained_random_seq::createEndPkt_SeqItemQ(T_SEQ_ITEM created, int num_be_created, DmaId_t startPkt_dma_id);
...
function vdma_mm_fault_h2c_constrained_random_seq::T_SEQ_ITEM vdma_mm_fault_h2c_constrained_random_seq::selectFault_2_Case(RatioFaultInjection_t fault_ratio);
  T_SEQ_ITEM created;
...
function vdma_mm_fault_h2c_constrained_random_seq::T_SEQ_ITEM_Q vdma_mm_fault_h2c_constrained_random_seq::selectFault_5_Case(RatioFaultInjection_t fault_ratio, T_SEQ_ITEM me, int num_be_created, DmaId_t startPkt_dma_id);
...
function vdma_mm_fault_h2c_constrained_random_seq::T_SEQ_ITEM_Q vdma_mm_fault_h2c_constrained_random_seq::createSeqItemQ(string name_postfix="");
...
function void vdma_mm_fault_h2c_constrained_random_seq::genCfg();
	...
	this.pkt_gathering_num_packet_end = 10;
...
task vdma_mm_fault_h2c_constrained_random_seq::pre_genCfg();
...
`endif // __VDMA_MM_FAULT_H2C_CONSTRAINED_RANDOM_SEQ_SVH__
