`ifndef __VDMA_MM_H2C_SMALL_GATHERING_SEQ_SVH__
`define __VDMA_MM_H2C_SMALL_GATHERING_SEQ_SVH__



class vdma_mm_h2c_small_gathering_seq extends vdma_mm_h2c_mst_seq;

  
  `uvm_object_utils(vdma_mm_h2c_small_gathering_seq)

  function new (string name="vdma_mm_h2c_small_gathering_seq");
	  super.new(name);
  endfunction
...
endclass:vdma_mm_h2c_small_gathering_seq



function void vdma_mm_h2c_small_gathering_seq::genCfg();
...
task vdma_mm_h2c_small_gathering_seq::pre_genCfg();
...
`endif // __VDMA_MM_H2C_SMALL_GATHERING_SEQ_SVH__
