`ifndef __VDMA_MM_H2C_MST_RANDOM_SEQ_SVH__
`define __VDMA_MM_H2C_MST_RANDOM_SEQ_SVH__
...
class vdma_mm_h2c_mst_random_seq extends vdma_mm_h2c_mst_seq;


  `uvm_object_utils(vdma_mm_h2c_mst_random_seq)

  function new (string name="vdma_mm_h2c_mst_random_seq");
    super.new(name);
  ...
  extern function MMH2CLenRange_t selectLenRange();
endclass:vdma_mm_h2c_mst_random_seq

function void vdma_mm_h2c_mst_random_seq::genCfg();
...
function MMH2CLenRange_t vdma_mm_h2c_mst_random_seq::selectLenRange();
  int             select_num;
  MMH2CLenRange_t range;
...
function Len_t vdma_mm_h2c_mst_random_seq::decideCstrLen();
  Len_t           rnd_len;
  MMH2CLenRange_t range;
...
task vdma_mm_h2c_mst_random_seq::pre_genCfg();
...
`endif // __VDMA_MM_H2C_MST_RANDOM_SEQ_SVH__
