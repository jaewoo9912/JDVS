`ifndef __VDMA_MM_FAULT_H2C_COVER_ALL_DMA_ID_BITS_FROM_DESC_FAULT_SEQ_SVH__
`define __VDMA_MM_FAULT_H2C_COVER_ALL_DMA_ID_BITS_FROM_DESC_FAULT_SEQ_SVH__



class vdma_mm_fault_h2c_cover_all_dma_id_bits_from_desc_fault_seq extends vdma_mm_h2c_mst_seq;
  local int seq_item_cnt = -1;

  `uvm_object_utils(vdma_mm_fault_h2c_cover_all_dma_id_bits_from_desc_fault_seq)

  function new (string name="vdma_mm_fault_h2c_cover_all_dma_id_bits_from_desc_fault_seq");
    super.new(name);
  endfunction
...
endclass:vdma_mm_fault_h2c_cover_all_dma_id_bits_from_desc_fault_seq


function DmaId_t vdma_mm_fault_h2c_cover_all_dma_id_bits_from_desc_fault_seq::decideDirectedDmaId();
  this.seq_item_cnt++;
...
function vdma_mm_fault_h2c_cover_all_dma_id_bits_from_desc_fault_seq::T_SEQ_ITEM vdma_mm_fault_h2c_cover_all_dma_id_bits_from_desc_fault_seq::createH2CFaultSeqItem(vdma_seq_item me);
...
function vdma_mm_fault_h2c_cover_all_dma_id_bits_from_desc_fault_seq::SeqItem_t vdma_mm_fault_h2c_cover_all_dma_id_bits_from_desc_fault_seq::createSeqItem_DataLenZero(string name_postfix="");
  vdma_seq_item created;
...
function vdma_mm_fault_h2c_cover_all_dma_id_bits_from_desc_fault_seq::T_SEQ_ITEM_Q vdma_mm_fault_h2c_cover_all_dma_id_bits_from_desc_fault_seq::createSeqItemQ(string name_postfix="");
  T_SEQ_ITEM    created;
...
function void vdma_mm_fault_h2c_cover_all_dma_id_bits_from_desc_fault_seq::genCfg();
...
task vdma_mm_fault_h2c_cover_all_dma_id_bits_from_desc_fault_seq::pre_genCfg();
...
`endif // __VDMA_MM_FAULT_H2C_COVER_ALL_DMA_ID_BITS_FROM_DESC_FAULT_SEQ_SVH__
