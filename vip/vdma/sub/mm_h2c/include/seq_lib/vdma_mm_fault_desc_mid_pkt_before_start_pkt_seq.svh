`ifndef __VDMA_MM_FAULT_DESC_MID_PKT_BEFORE_START_PKT_SEQ_SVH__
`define __VDMA_MM_FAULT_DESC_MID_PKT_BEFORE_START_PKT_SEQ_SVH__



class vdma_mm_fault_desc_mid_pkt_before_start_pkt_seq extends vdma_mm_h2c_mst_seq;


	`uvm_object_utils(vdma_mm_fault_desc_mid_pkt_before_start_pkt_seq)

	function new (string name="vdma_mm_fault_desc_mid_pkt_before_start_pkt_seq");
		super.new(name);
	endfunction
...
endclass:vdma_mm_fault_desc_mid_pkt_before_start_pkt_seq

function vdma_mm_fault_desc_mid_pkt_before_start_pkt_seq::T_SEQ_ITEM_Q vdma_mm_fault_desc_mid_pkt_before_start_pkt_seq::createH2CFaultSeqItemQ(T_SEQ_ITEM created, int num_be_created, DmaId_t startPkt_dma_id);
...
function vdma_mm_fault_desc_mid_pkt_before_start_pkt_seq::T_SEQ_ITEM_Q vdma_mm_fault_desc_mid_pkt_before_start_pkt_seq::createSeqItemQ(string name_postfix="");
...
function void vdma_mm_fault_desc_mid_pkt_before_start_pkt_seq::genCfg();
...
task vdma_mm_fault_desc_mid_pkt_before_start_pkt_seq::pre_genCfg();
...
`endif // __VDMA_MM_FAULT_DESC_MID_PKT_BEFORE_START_PKT_SEQ_SVH__
