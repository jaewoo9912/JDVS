`ifndef __VDMA_MM_FAULT_H2C_ALL_RANDOM_SEQ_SVH__
`define __VDMA_MM_FAULT_H2C_ALL_RANDOM_SEQ_SVH__



class vdma_mm_fault_h2c_all_random_seq extends vdma_mm_h2c_mst_seq;


  `uvm_object_utils(vdma_mm_fault_h2c_all_random_seq)

  function new (string name="vdma_mm_fault_h2c_all_random_seq");
	  super.new(name);
...
endclass:vdma_mm_fault_h2c_all_random_seq


function vdma_mm_fault_h2c_all_random_seq::T_SEQ_ITEM vdma_mm_fault_h2c_all_random_seq::makeSeqItem_DataLenZero(T_SEQ_ITEM me);
...
function vdma_mm_fault_h2c_all_random_seq::SeqItem_t vdma_mm_fault_h2c_all_random_seq::createDataLenZero_SeqItem(string name_postfix="");
  vdma_seq_item created;
...
function vdma_mm_fault_h2c_all_random_seq::T_SEQ_ITEM vdma_mm_fault_h2c_all_random_seq::selectFault_2_Case(RatioFaultInjection_t fault_ratio);
  T_SEQ_ITEM created;
...
function vdma_mm_fault_h2c_all_random_seq::T_SEQ_ITEM_Q vdma_mm_fault_h2c_all_random_seq::createSeqItemQ(string name_postfix="");
...
function void vdma_mm_fault_h2c_all_random_seq::genCfg();
...
task vdma_mm_fault_h2c_all_random_seq::pre_genCfg();
...
`endif // __VDMA_MM_FAULT_H2C_ALL_RANDOM_SEQ_SVH__
