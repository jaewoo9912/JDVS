`ifndef __VDMA_ST_FAULT_H2C_CONSTRAINED_RANDOM_SEQ_SVH__
`define __VDMA_ST_FAULT_H2C_CONSTRAINED_RANDOM_SEQ_SVH__



class vdma_st_fault_h2c_constrained_random_seq extends vdma_st_h2c_mst_seq;


	`uvm_object_utils(vdma_st_fault_h2c_constrained_random_seq)

	function new (string name="vdma_st_fault_h2c_constrained_random_seq");
		super.new(name);
...
endclass:vdma_st_fault_h2c_constrained_random_seq


function vdma_st_fault_h2c_constrained_random_seq::T_SEQ_ITEM vdma_st_fault_h2c_constrained_random_seq::createDataLenZero_SeqItemQ(T_SEQ_ITEM me);
...
function vdma_st_fault_h2c_constrained_random_seq::T_SEQ_ITEM_Q vdma_st_fault_h2c_constrained_random_seq::createDataLenZeroPkt_SeqItemQ(T_SEQ_ITEM created, int num_be_created, DmaId_t startPkt_dma_id);
...
function vdma_st_fault_h2c_constrained_random_seq::SeqItem_t vdma_st_fault_h2c_constrained_random_seq::createDataLenZero_SeqItem(string name_postfix="");
  vdma_seq_item created;
...
function vdma_st_fault_h2c_constrained_random_seq::T_SEQ_ITEM_Q vdma_st_fault_h2c_constrained_random_seq::createMidPkt_SeqItemQ(T_SEQ_ITEM created, int num_be_created, DmaId_t startPkt_dma_id);
...
function vdma_st_fault_h2c_constrained_random_seq::T_SEQ_ITEM_Q vdma_st_fault_h2c_constrained_random_seq::createSoloPkt_SeqItemQ(T_SEQ_ITEM created, int num_be_created, DmaId_t startPkt_dma_id);
...
function vdma_st_fault_h2c_constrained_random_seq::T_SEQ_ITEM_Q vdma_st_fault_h2c_constrained_random_seq::createStartPkt_SeqItemQ(T_SEQ_ITEM created, int num_be_created, DmaId_t startPkt_dma_id);
...
function vdma_st_fault_h2c_constrained_random_seq::T_SEQ_ITEM_Q vdma_st_fault_h2c_constrained_random_seq::createEndPkt_SeqItemQ(T_SEQ_ITEM created, int num_be_created, DmaId_t startPkt_dma_id);
...
function vdma_st_fault_h2c_constrained_random_seq::T_SEQ_ITEM vdma_st_fault_h2c_constrained_random_seq::selectFault_2_Case(RatioFaultInjection_t fault_ratio);
  T_SEQ_ITEM created;
...
function vdma_st_fault_h2c_constrained_random_seq::T_SEQ_ITEM_Q vdma_st_fault_h2c_constrained_random_seq::selectFault_5_Case(RatioFaultInjection_t fault_ratio, T_SEQ_ITEM me, int num_be_created, DmaId_t startPkt_dma_id);
...
function vdma_st_fault_h2c_constrained_random_seq::T_SEQ_ITEM_Q vdma_st_fault_h2c_constrained_random_seq::createSeqItemQ(string name_postfix="");
...
function void vdma_st_fault_h2c_constrained_random_seq::genCfg();
...
task vdma_st_fault_h2c_constrained_random_seq::pre_genCfg();
...
`endif // __VDMA_ST_FAULT_H2C_CONSTRAINED_RANDOM_SEQ_SVH__
