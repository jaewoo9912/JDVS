`ifndef __VDMA_ST_H2C_ASYMMETRIC_LATENCY_SEQ_SVH__
`define __VDMA_ST_H2C_ASYMMETRIC_LATENCY_SEQ_SVH__



class vdma_st_h2c_asymmetric_latency_seq extends vdma_st_h2c_mst_seq;

  
  `uvm_object_utils(vdma_st_h2c_asymmetric_latency_seq)

  function new (string name="vdma_st_h2c_asymmetric_latency_seq");
     super.new(name);
...
endclass:vdma_st_h2c_asymmetric_latency_seq

function void vdma_st_h2c_asymmetric_latency_seq::genCfg();
...
task vdma_st_h2c_asymmetric_latency_seq::pre_genCfg();
...
`endif // __VDMA_ST_H2C_ASYMMETRIC_LATENCY_SEQ_SVH__
