`ifndef __VDMA_ST_FAULT_H2C_COVER_ALL_DMA_ID_BITS_FROM_HOST_FAULT_SEQ_SVH__
`define __VDMA_ST_FAULT_H2C_COVER_ALL_DMA_ID_BITS_FROM_HOST_FAULT_SEQ_SVH__

class vdma_st_fault_h2c_cover_all_dma_id_bits_from_host_fault_seq extends vdma_st_h2c_mst_seq;
  local int seq_item_cnt = -1;
	
  typedef vdma_seq_item SeqItem_t;
  `uvm_object_utils(vdma_st_fault_h2c_cover_all_dma_id_bits_from_host_fault_seq)

  function new (string name="vdma_st_fault_h2c_cover_all_dma_id_bits_from_host_fault_seq");
    super.new(name);
...
endclass:vdma_st_fault_h2c_cover_all_dma_id_bits_from_host_fault_seq


function DmaId_t vdma_st_fault_h2c_cover_all_dma_id_bits_from_host_fault_seq::decideDirectedDmaId();
  this.seq_item_cnt++;
...
function vdma_st_fault_h2c_cover_all_dma_id_bits_from_host_fault_seq::SeqItem_t vdma_st_fault_h2c_cover_all_dma_id_bits_from_host_fault_seq::createSeqItem(string name_postfix="");
...
function void vdma_st_fault_h2c_cover_all_dma_id_bits_from_host_fault_seq::genCfg();
