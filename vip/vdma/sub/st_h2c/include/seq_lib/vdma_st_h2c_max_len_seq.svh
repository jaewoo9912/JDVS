`ifndef __VDMA_ST_H2C_MAX_LEN_SEQ_SVH__
`define __VDMA_ST_H2C_MAX_LEN_SEQ_SVH__




class vdma_st_h2c_max_len_seq extends vdma_st_h2c_mst_seq;
   
  `uvm_object_utils(vdma_st_h2c_max_len_seq)

  function new (string name="vdma_st_h2c_max_len_seq");
	  super.new(name);
...
endclass:vdma_st_h2c_max_len_seq


function void vdma_st_h2c_max_len_seq::genCfg();
...
function vdma_st_h2c_max_len_seq::Len_t vdma_st_h2c_max_len_seq::decideCstrLen();
	return(MAX_DMA_LEN);
...
task vdma_st_h2c_max_len_seq::pre_genCfg();
