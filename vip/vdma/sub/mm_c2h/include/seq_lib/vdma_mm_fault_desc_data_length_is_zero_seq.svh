`ifndef __VDMA_MM_FAULT_DESC_DATA_LENGTH_IS_ZERO_SEQ_SVH__
`define __VDMA_MM_FAULT_DESC_DATA_LENGTH_IS_ZERO_SEQ_SVH__



class vdma_mm_fault_desc_data_length_is_zero_seq extends vdma_mm_c2h_mst_seq;
	

	`uvm_object_utils(vdma_mm_fault_desc_data_length_is_zero_seq)

	function new (string name="vdma_mm_fault_desc_data_length_is_zero_seq");
		super.new(name);
	endfunction
...
endclass:vdma_mm_fault_desc_data_length_is_zero_seq

function vdma_mm_fault_desc_data_length_is_zero_seq::T_SEQ_ITEM vdma_mm_fault_desc_data_length_is_zero_seq::createC2HFaultSeqItemQ(vdma_seq_item me);
...
function vdma_mm_fault_desc_data_length_is_zero_seq::SeqItem_t vdma_mm_fault_desc_data_length_is_zero_seq::createSeqItem1(string name_postfix="");
	vdma_seq_item created;
...
function vdma_mm_fault_desc_data_length_is_zero_seq::T_SEQ_ITEM_Q vdma_mm_fault_desc_data_length_is_zero_seq::createSeqItemQ(string name_postfix="");
...
function void vdma_mm_fault_desc_data_length_is_zero_seq::genCfg();
...
task vdma_mm_fault_desc_data_length_is_zero_seq::pre_genCfg();
...
`endif // __VDMA_MM_FAULT_DESC_DATA_LENGTH_IS_ZERO_SEQ_SVH__
