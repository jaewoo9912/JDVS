`ifndef __VDMA_MM_FAULT_CARD_R_WRONG_DMA_ID_SEQ_SVH__
`define __VDMA_MM_FAULT_CARD_R_WRONG_DMA_ID_SEQ_SVH__



class vdma_mm_fault_card_r_wrong_dma_id_seq extends vdma_mm_c2h_mst_seq;
	string family_name;


	`uvm_object_utils(vdma_mm_fault_card_r_wrong_dma_id_seq)

	function new (string name="vdma_mm_fault_card_r_wrong_dma_id_seq");
		super.new(name);
	endfunction
...
endclass:vdma_mm_fault_card_r_wrong_dma_id_seq

function vdma_mm_fault_card_r_wrong_dma_id_seq::T_SEQ_ITEM vdma_mm_fault_card_r_wrong_dma_id_seq::createC2HFaultSeqItemQ(vdma_seq_item me);
...
function vdma_mm_fault_card_r_wrong_dma_id_seq::T_SEQ_ITEM_Q vdma_mm_fault_card_r_wrong_dma_id_seq::createSeqItemQ(string name_postfix="");
...
function void vdma_mm_fault_card_r_wrong_dma_id_seq::genCfg();
...
task vdma_mm_fault_card_r_wrong_dma_id_seq::pre_genCfg();
...
`endif // __VDMA_MM_FAULT_CARD_R_WRONG_DMA_ID_SEQ_SVH__
