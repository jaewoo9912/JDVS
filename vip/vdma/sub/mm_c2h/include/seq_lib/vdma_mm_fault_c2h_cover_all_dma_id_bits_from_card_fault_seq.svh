`ifndef __VDMA_MM_FAULT_C2H_COVER_ALL_DMA_ID_BITS_FROM_CARD_FAULT_SEQ_SVH__
`define __VDMA_MM_FAULT_C2H_COVER_ALL_DMA_ID_BITS_FROM_CARD_FAULT_SEQ_SVH__




class vdma_mm_fault_c2h_cover_all_dma_id_bits_from_card_fault_seq extends vdma_mm_c2h_mst_seq;
  local int seq_item_cnt = -1;

  typedef vdma_seq_item SeqItem_t;
  `uvm_object_utils(vdma_mm_fault_c2h_cover_all_dma_id_bits_from_card_fault_seq)

  function new (string name="vdma_mm_fault_c2h_cover_all_dma_id_bits_from_card_fault_seq");
    super.new(name);
  endfunction
...
endclass:vdma_mm_fault_c2h_cover_all_dma_id_bits_from_card_fault_seq


function DmaId_t vdma_mm_fault_c2h_cover_all_dma_id_bits_from_card_fault_seq::decideDirectedDmaId();
  this.seq_item_cnt++;
...
function vdma_mm_fault_c2h_cover_all_dma_id_bits_from_card_fault_seq::SeqItem_t vdma_mm_fault_c2h_cover_all_dma_id_bits_from_card_fault_seq::createSeqItem(string name_postfix="");
...
function void vdma_mm_fault_c2h_cover_all_dma_id_bits_from_card_fault_seq::genCfg();
...
`endif // __VDMA_MM_FAULT_C2H_COVER_ALL_DMA_ID_BITS_FROM_CARD_FAULT_SEQ_SVH__
