`ifndef __VDMA_MM_C2H_MST_ADDR_BOUNDAYR_SEQ_SVH__
`define __VDMA_MM_C2H_MST_ADDR_BOUNDARY_SEQ_SVH__




class vdma_mm_c2h_mst_addr_boundary_seq extends vdma_mm_c2h_mst_seq;


  `uvm_object_utils(vdma_mm_c2h_mst_addr_boundary_seq)

  function new (string name="vdma_mm_c2h_mst_addr_boundary_seq");
    super.new(name);
...
endclass:vdma_mm_c2h_mst_addr_boundary_seq

function Addr_t vdma_mm_c2h_mst_addr_boundary_seq::decideCstrAddr();
  Addr_t rnd_value;
...
function void vdma_mm_c2h_mst_addr_boundary_seq::genCfg();
...
task vdma_mm_c2h_mst_addr_boundary_seq::pre_genCfg();
...
`endif // __VDMA_MM_C2H_MST_ADDR_BOUNDARY_SEQ_SVH__
