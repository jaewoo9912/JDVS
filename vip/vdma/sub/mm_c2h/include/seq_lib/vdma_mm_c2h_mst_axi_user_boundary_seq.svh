`ifndef __VDMA_MM_C2H_MST_AXI_USER_BOUNDARY_SEQ_SVH__
`define __VDMA_MM_C2H_MST_AXI_USER_BOUNDARY_SEQ_SVH__



class vdma_mm_c2h_mst_axi_user_boundary_seq extends vdma_mm_c2h_mst_seq;

  
  `uvm_object_utils(vdma_mm_c2h_mst_axi_user_boundary_seq)

  function new (string name="vdma_mm_c2h_mst_axi_user_boundary_seq");
	  super.new(name);
  endfunction
...
endclass:vdma_mm_c2h_mst_axi_user_boundary_seq

function vdma_mm_c2h_mst_axi_user_boundary_seq::FncId_t vdma_mm_c2h_mst_axi_user_boundary_seq::decideCstrFnc_Id();
	FncId_t rnd_fnc_id;
...
function vdma_mm_c2h_mst_axi_user_boundary_seq::StrId_t vdma_mm_c2h_mst_axi_user_boundary_seq::decideCstrStr_Id();
	StrId_t rnd_str_id;
...
function void vdma_mm_c2h_mst_axi_user_boundary_seq::genCfg();
...
task vdma_mm_c2h_mst_axi_user_boundary_seq::pre_genCfg();
...
`endif // __VDMA_MM_C2H_MST_AXI_USER_BOUNDARY_SEQ_SVH__
